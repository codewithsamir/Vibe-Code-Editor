...
import DisplayRepo from "./DisplayReop"
...
const AddRepo = () => {
  ...
  const openDialog = () => {
    if (!session?.accessToken) {
      alert("No GitHub token found. Please login again.")
      return
    }
  ...
  return (
    <>
      ...
      <DisplayRepo
        ...
        username={session?.user?.name || ""} // or session?.user?.login depending on your GitHub OAuth
      />
    </>
  )
}
