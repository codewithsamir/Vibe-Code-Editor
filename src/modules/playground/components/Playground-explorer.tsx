...
export function TemplateFileTree({
  ...
  return (
    <Sidebar>
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupLabel className="text-md capitalize mb-2">{title}</SidebarGroupLabel>
          <DropdownMenu>
...
const fileIcon = getFileIcon(file.fileExtension);
    ...
    const folderIcon = getFolderIcon(item.folderName, isOpen);
