...
//    Write your logic here
  ...
  const handleUpdateProject = async () => {
   if(!selectedProject || !onUpdateProject) return;
        ...
        try {
          ...
          toast.success("Projecct updated successfully")
        } catch (error) {
          console.log(error)
  ...
  const handleDeleteProject = async () => {
     ...
     try {
      ...
      console.log("Error deleteding project", error)
  ...
  const handleDuplicateProject = async (project: Project) => {
    ...
    try {
      ...
      toast.success("Project duplicated project")
...
toast.success("Project Url successfully copied")
